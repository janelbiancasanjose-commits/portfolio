  ...
  "node_modules/bootstrap/dist/js/bootstrap.min.js"(exports, module) {
    !(function(t, e) {
      ...
      function P(t2, e2, i2, s2, n2) {
        ...
        const d2 = I(r2, e2.replace(A, "")), u2 = o2 ? /* @__PURE__ */ (function(t3, e3, i3) {
          return function s3(n3) {
            const o3 = t3.querySelectorAll(e3);
            for (let { target: r3 } = n3; r3 && r3 !== this; r3 = r3.parentNode) for (const a3 of o3) if (a3 === r3) return F(n3, { delegateTarget: r3 }), s3.oneOff && $.off(t3, n3.type, e3, i3), i3.apply(r3, [n3]);
          };
      ...
      function M(t2, e2, i2, s2) {
        const n2 = e2[i2] || {};
        for (const o2 of Object.keys(n2)) if (o2.includes(s2)) {
          const s3 = n2[o2];
      ...
      class R {
        ...
        _typeCheckConfig(t2, e2 = this.constructor.DefaultType) {
          for (const s2 of Object.keys(e2)) {
            ...
            if (!new RegExp(n2).test(r2)) throw new TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${s2}" provided type "${r2}" but expected type "${n2}".`);
          }
          var i2;
        }
      }
      ...
      class ht extends V {
        ...
        _addTouchEventListeners() {
          for (const t3 of U.find(".carousel-item img", this._element)) $.on(t3, "dragstart.bs.carousel", ((t4) => t4.preventDefault()));
      ...
      $.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", (function(t2) {
        const e2 = r(this);
        if (!e2 || !e2.classList.contains(ot)) return;
        t2.preventDefault();
        ...
        for (const e2 of t2) ht.getOrCreateInstance(e2);
      })), b(ht);
      ...
      class mt extends V {
        ...
        show() {
          ...
          let t2 = [];
          if (this._config.parent && (t2 = this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter(((t3) => t3 !== this._element)).map(((t3) => mt.getOrCreateInstance(t3, { toggle: false })))), t2.length && t2[0]._isTransitioning) return;
      ...
      $.on(document, "click.bs.collapse.data-api", gt, (function(t2) {
        ...
        for (const t3 of i2) mt.getOrCreateInstance(t3, { toggle: false }).toggle();
      })), b(mt);
      ...
      class Mt extends V {
        ...
        show() {
          ...
          if (!$.trigger(this._element, "show.bs.dropdown", t2).defaultPrevented) {
            if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav")) for (const t3 of [].concat(...document.body.children)) $.on(t3, "mouseover", _);
        ...
        _completeHide(t2) {
          if (!$.trigger(this._element, "hide.bs.dropdown", t2).defaultPrevented) {
            if ("ontouchstart" in document.documentElement) for (const t3 of [].concat(...document.body.children)) $.off(t3, "mouseover", _);
        ...
        _getConfig(t2) {
          if ("object" == typeof (t2 = super._getConfig(t2)).reference && !l(t2.reference) && "function" != typeof t2.reference.getBoundingClientRect) throw new TypeError(`${bt.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
          return t2;
        }
        _createPopper() {
        ...
        _getPlacement() {
          ...
          if (t2.classList.contains("dropend")) return Dt;
          if (t2.classList.contains("dropstart")) return Nt;
      ...
      class ne extends V {
        ...
        dispose() {
          for (const t2 of [window, this._dialog]) $.off(t2, ".bs.modal");
      ...
      $.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', (function(t2) {
        ...
        for (const t2 of U.find(le)) _e.getOrCreateInstance(t2).show();
      })), $.on(window, "resize.bs.offcanvas", (() => {
        for (const t2 of U.find("[aria-modal][class*=show][class*=offcanvas-]")) "fixed" !== getComputedStyle(t2).position && _e.getOrCreateInstance(t2).hide();
      })), K(_e), b(_e);
      ...
      class Ae extends R {
        ...
        _checkContent(t2) {
          for (const [e2, i2] of Object.entries(t2)) super._typeCheckConfig({ selector: e2, entry: i2 }, we);
        }
        ...
        _maybeSanitize(t2) {
          return this._config.sanitize ? (function(t3, e2, i2) {
            ...
            for (const t4 of n2) {
              ...
              for (const e3 of s3) me(e3, n3) || t4.removeAttribute(e3.nodeName);
            }
      ...
      class Pe extends V {
        ...
        show() {
          ...
          if (this._element.ownerDocument.documentElement.contains(this.tip) || (s2.append(i2), $.trigger(this._element, this.constructor.eventName("inserted"))), this._popper = this._createPopper(i2), i2.classList.add(Te), "ontouchstart" in document.documentElement) for (const t3 of [].concat(...document.body.children)) $.on(t3, "mouseover", _);
          this._queueCallback((() => {
        ...
        hide() {
          if (this._isShown() && !$.trigger(this._element, this.constructor.eventName("hide")).defaultPrevented) {
            if (this._getTipElement().classList.remove(Te), "ontouchstart" in document.documentElement) for (const t2 of [].concat(...document.body.children)) $.off(t2, "mouseover", _);
        ...
        _setListeners() {
          ...
          for (const e2 of t2) if ("click" === e2) $.on(this._element, this.constructor.eventName("click"), this._config.selector, ((t3) => {
        ...
        _getConfig(t2) {
          ...
          for (const t3 of Object.keys(e2)) Ee.has(t3) && delete e2[t3];
      ...
      class Be extends V {
        ...
        _activateParents(t2) {
          if (t2.classList.contains("dropdown-item")) U.findOne(".dropdown-toggle", t2.closest(".dropdown")).classList.add(Fe);
          else for (const e2 of U.parents(t2, ".nav, .list-group")) for (const t3 of U.prev(e2, ".nav-link, .nav-item > .nav-link, .list-group-item")) t3.classList.add(Fe);
        }
      ...
      $.on(window, "load.bs.scrollspy.data-api", (() => {
        for (const t2 of U.find('[data-bs-spy="scroll"]')) Be.getOrCreateInstance(t2);
      })), b(Be);
      ...
      class Je extends V {
        ...
        _keydown(t2) {
          if (![We, Re, Ve, Ke].includes(t2.key)) return;
      ...
      $.on(document, "click.bs.tab", Ue, (function(t2) {
        ...
        for (const t2 of U.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]')) Je.getOrCreateInstance(t2);
      })), b(Je);
